import {
  GetPelatiahnPenilaianPesertaByIdPeserta,
  GetPenilaianPelatihanPesertaById,
...
const DetailPenilaianTranskripNilai = () => {
  ...
  const getData = async () => {
    setLoading(true);
    try {
      const getDataPelatihan = await GetPelatiahnPenilaianPesertaByIdPeserta(
        idPelatihan
      );
      const getData = await GetPenilaianPelatihanPesertaById(idPelatihan);
      console.log(getData);
...
export default DetailPenilaianTranskripNilai;
