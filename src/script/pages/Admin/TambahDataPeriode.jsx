...
import { PostPeriode } from "../../config/ApiService";
import { useEffect, useState } from "react";
import Swal from "sweetalert2";

const TambahDataPeriode = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try{
    const PostDataPeriode = await PostPeriode(form);
      await Swal.fire({
        title: "Berhasil",
        text: "Berhasil menambah periode",
        icon: "success",
      }).then(() => {
        setForm({
          nama: "",
...
export default TambahDataPeriode;
