...
import { FaEye, FaPencilAlt, FaTrash, FaPen, FaPlus } from "react-icons/fa";
import { useNavigate } from "react-router-dom";
import { GetPelatihanByInstrukrurById, GetAllPesertaPelatihanById, PutPeringkatPeserta } from "../../config/ApiService";
            ...
            >
                  ...
                  <div className="w-full pb-8 pt-6 border-t-4 border-blue-800 rounded-md shadow-md print:shadow-none print:border-none">
                    ...
                    <div className="grid grid-cols-1 mt-6 md:grid-cols-2 gap-4 px-4 print:grid-cols-2 print:gap-0 print:text-sm">
                      <div className="border-0 sm:border print:border-none rounded-sm p-0 flex print:p-1">
                        ...
                        <span className="truncate">: {pelatihan.nama}</span>
                      </div>
                      <div className="border-0 sm:border print:border-none rounded-sm p-0 flex print:p-1">
                        <span className="w-28 flex-shrink-0 block print:font-semibold">
                          Tanggal Mulai
                        ...
                        <span className="truncate">
                          :{" "}
                          {new Date(pelatihan.tanggalMulai).toLocaleDateString(
                            "id-ID",
                            {
                              weekday: "long",
                              year: "numeric",
              ...
              <div className="w-full flex justify-end items-center mb-3">
                <div
                  ...
                  onClick={() => navigate(`/admin/tambah-pelatihan/${pelatihan.id}`)}
                >
                            ...
                            >
                              ...
                              <td className="px-6 py-4 flex gap-2">
                                <FaEye
                                  onClick={() =>
                                    navigate(
                                      `/transkrip-nilai-admin/${pelatihan.penilaian.id}/${idPelatihan}/${peserta.userId}`
                                    )
                                  }
