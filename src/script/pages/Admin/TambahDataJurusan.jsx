...
import { PostJurusan } from "../../config/ApiService";
import { useEffect, useState } from "react";
import Swal from "sweetalert2";
import { useNavigate } from "react-router-dom";

const TambahDataJurusan = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const PostData = await PostJurusan(form);
      await Swal.fire({
        title: "Berhasil",
        text: "Berhasil menambah jurusan",
        icon: "success",
      }).then(() => {
...
export default TambahDataJurusan;
