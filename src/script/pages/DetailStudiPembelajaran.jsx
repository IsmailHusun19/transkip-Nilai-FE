...
import { GetPelatihanByPesertaById } from "../config/ApiService";
import { useEffect, useState, useRef } from "react";
import { useReactToPrint } from "react-to-print";
import '../../style/app.css'
import KopSurat from "../component/KopSurat";

const DetailStudiPembelajaran = () => {
  ...
  const getData = async () => {
    setLoading(true);
    try {
      const getDataPelatihan = await GetPelatihanByPesertaById(idPelatihan);
                  ...
                  <div className="border-0 sm:border print:border-none rounded-sm p-0 flex print:p-1">
                    ...
                    <span className="truncate">
                      ...
                      {(() => {
                        ...
                        const periode = pelatihan.pelatihan.periode.nama.toLowerCase();;
                        let tahun = 0;
                        let bulan = 0;
            ...
            <div className="relative overflow-x-auto pb-16 mt-5">
              <div className="shadow-md print:shadow-none">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    {pelatihan.pelatihan.penilaian.penilaian.length === 0 ? (
                      <>
                        <tr>
                          <td
                            colSpan={3}
                      ...
                      <>
                        {pelatihan.pelatihan.penilaian.penilaian.map(
                          (pelatihan, index) => (
                            <tr
                              key={index}
...
export default DetailStudiPembelajaran;
