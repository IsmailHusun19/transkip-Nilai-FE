      ...
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 my-4 w-full xl:w-1/3">
            ...
            <p className="mt-2">
            BBPVP Serang adalah singkatan dari Balai Besar Pelatihan Vokasi dan Produktivitas Serang. Ini adalah salah satu unit pelatihan kerja milik pemerintah yang berada di bawah naungan Kementerian Ketenagakerjaan Republik Indonesia (Kemnaker RI).
            </p>
          </div>
      ...
      <div className="container mx-auto px-4">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            ...
            BBPVP Serang All Rights Reserved.
          </div>
        </div>
      </div>
    </div>
